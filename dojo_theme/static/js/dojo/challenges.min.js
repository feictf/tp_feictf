...
// function downloadBinary(event) {
//   event.preventDefault();
//   const category_name = $("#category-name").text();
//  let challenge_name = $("#challenge-name").text();
//  challenge_name = challenge_name.replace(/\s+/g, "");
//
//   const endpoint = category_name + "/" + challenge_name;
//   console.log("/pwncollege_api/v1/download/" + endpoint);
//   CTFd.fetch("/pwncollege_api/v1/download/" + endpoint, {
//     method: "GET",
//     headers: {
...
$(() => {
  ...
  challenge_name = challenge_name.replace(/\s+/g, "");
  const endpoint =
    "http://45.76.133.227/pwncollege_api/v1/download/" +
    category_name +
    "/" +
    challenge_name;
  $("#challenge-download").attr("href", endpoint);
  ...
  //$(".card").find("#challenge-download").click(downloadBinary);
});
